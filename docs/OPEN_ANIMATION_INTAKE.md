...
The public UAL1/UAL2 downloads used by the fetcher are the OpenGameArt standard distributions, both explicitly listed as CC0 and attributed to Quaternius. UAL1's public standard package contains 45 of the 120+ advertised animations; UAL2's public standard package is the 130+ library's standard distribution. The fetcher therefore records actual downloaded bytes rather than assuming the full advertised catalog is present.