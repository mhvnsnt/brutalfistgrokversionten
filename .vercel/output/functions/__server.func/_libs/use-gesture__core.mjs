	...
	function resolveWith(config = {}, resolvers) {
		...
		for (const [key, resolver] of Object.entries(resolvers)) switch (typeof resolver) {
			...
			case "object":
				...
				break;
			case "boolean": if (resolver) result[key] = config[key];
		}
		return result;
	}
...
//#endregion
//#region node_modules/@use-gesture/core/utils/dist/use-gesture-core-utils.cjs.prod.js
var require_use_gesture_core_utils_cjs_prod = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.rubberbandIfOutOfBounds = require_maths_83bc6f64_cjs_prod().rubberbandIfOutOfBounds;
}));
//#endregion
//#region node_modules/@use-gesture/core/utils/dist/use-gesture-core-utils.cjs.js
var require_use_gesture_core_utils_cjs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_use_gesture_core_utils_cjs_prod();
}));
//#endregion
//#region node_modules/@use-gesture/core/types/dist/use-gesture-core-types.cjs.prod.js
var require_use_gesture_core_types_cjs_prod = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@use-gesture/core/types/dist/use-gesture-core-types.cjs.js
var require_use_gesture_core_types_cjs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_use_gesture_core_types_cjs_prod();
}));
//#endregion
export { require_use_gesture_core_actions_cjs as i, require_use_gesture_core_utils_cjs as n, require_use_gesture_core_cjs as r, require_use_gesture_core_types_cjs as t };
